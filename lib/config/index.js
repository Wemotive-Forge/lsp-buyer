...
//     nconf.set('express:port', process.env.PORT);
    ...
    nconf.set('sellerConfig:LOGISTICS_BAP_URI', process.env.LOGISTICS_BAP_URI);
    nconf.set('sellerConfig:RETAIL_BPP_URI', process.env.RETAIL_BPP_URI);
    ...
    nconf.set('database:REDIS', process.env.REDIS);
